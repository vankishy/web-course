...
CREATE TABLE `detail_course` (
  ...
  `type` enum('PDF','Video') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `user_profile` (
  ...
  `user_id` int DEFAULT NULL,
  `lainnya` text COLLATE utf8mb4_general_ci COMMENT 'kolom lainnya',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `watchlater` (
  ...
  KEY `user_id` (`user_id`),
  KEY `watchlater_ibfk_1_idx` (`detail_course_id`),
  CONSTRAINT `watchlater_ibfk_1` FOREIGN KEY (`detail_course_id`) REFERENCES `detail_course` (`detail_course_id`),
...
-- Dump completed on 2025-11-06 16:15:43
